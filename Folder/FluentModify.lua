        ...
        {"MainModule"},
        {
            ...
            },
            {
                ...
                {"Elements"},
                {
                    ...
                    {59, "ModuleScript", {"Discord"}},
                    {60, "ModuleScript", {"Viewport"}},
                    {61, "ModuleScript", {"Video"}},
                    {62, "ModuleScript", {"Image"}},
                    {63, "ModuleScript", {"Social"}},
                    {64, "ModuleScript", {"Group"}}
                }
            },
            {
                29,
...
local aa = {
    function()
        ...
        function SaveManager:BuildConfigSection(tab)
            ...
            sec:AddDropdown("SaveManager_ConfigList",{Title="Config list",Values=self:RefreshConfigList(),AllowNull=true,NoSearch=true,Icon="solar/list-bold",DropdownOutsideWindow=false,IsManagerDropdown=true})
        ...
        InterfaceManager.Settings = { Theme="Deep Ocean", Acrylic=true, Transparency=true, Animated=true, MenuKeybind="LeftControl", Font="GothamSSm", DisableBG=false, Favorites={} }
        ...
        function FloatingButtonManager:BuildConfigSection(tab)
            ...
            section:AddDropdown("FB_ConfigList",{Title="Layouts list",Values=self:RefreshConfigList(),AllowNull=true,NoSearch=true,Icon="solar/list-bold",DropdownOutsideWindow=false,IsManagerDropdown=true})
    ...
    [12] = function()
        ...
        function o.New(p, q)
            ...
            [q.Type or "Info"] or Color3.fromRGB(76,194,255)
            local stripe =
                n("Frame",{
            ...
            local notifRootChildren = 
            {
                r.AcrylicPaint.Frame,
                r.Title, r.CloseButton,
                notifCopyBtn,
                r.LabelHolder,
                stripe
            }
            if q.Icon then
                ...
                if ic then
                    ...
                    if type(ic) == "table" then 
                        nicoImg.Image = ic.Image or ""
                        nicoImg.ImageRectOffset = ic.ImageRectOffset or Vector2.new()
                        nicoImg.ImageRectSize = ic.ImageRectSize or Vector2.new()
                    else
                        nicoImg.Image = tostring(ic)
                    end
            ...
            r.Root =
                n(
                "Frame",
                {BackgroundTransparency = 1, Size = UDim2.new(1, 0, 1, 0), Position = UDim2.fromOffset(0, -100)},
                notifRootChildren
            )
            if q.Content == "" then
            ...
            j.AddSignal(r.Holder.InputBegan, function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    dragging = true
                    dragStart = input.Position
                    startPos = r.Root.Position
                end
            end)
            j.AddSignal(r.Holder.InputChanged, function(input)
                if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    local delta = input.Position - dragStart
                    if delta.Y < 0 then
                        r.Root.Position = UDim2.new(startPos.X.Scale, startPos.X.Offset, startPos.Y.Scale, startPos.Y.Offset + delta.Y)
                    end
                end
            end)
            j.AddSignal(r.Holder.InputEnded, function(input)
                if dragging and (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
                    ...
                    if delta.Y < -20 then
                        ...
                        r.Root.Position = UDim2.new(0, 0, 0, 0)
                    end
                end
            end)
            local s = i.GroupMotor.new {Scale = 0, Offset = -100}
            s:onStep(
                function(t)
                    r.Root.Position = UDim2.new(0, 0, t.Scale, t.Offset)
                end
            )
            j.AddSignal(
            ...
            function r.Close(t)
                if not r.Closed then
                    ...
                    task.spawn(
                        function()
                            s:setGoal {Scale = l(0, {frequency = 5}), Offset = l(-150, {frequency = 5})}
                            task.wait(0.4)
    ...
    [13] = function()
        ...
        return function(k, l, iconParam)
            ...
            local iconData = nil
            if iconParam and library and library.GetIcon then
                iconData = library:GetIcon(iconParam) or iconParam
            end
            if iconData == "" then iconData = nil end

            local hasIcon = iconData ~= nil
            local textPosition = hasIcon and UDim2.fromOffset(22, 2) or UDim2.fromOffset(0, 2)
            local textSize = hasIcon and UDim2.new(1, -38, 0, 18) or UDim2.new(1, -16, 0, 18)
                ...
                {BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 26), LayoutOrder = 7, Parent = l},
                {
                    j(
                        "ImageLabel",
                        {
                            ...
                            ImageRectOffset = (iconData and type(iconData) == "table") and iconData.ImageRectOffset or Vector2.new(0,0),
                            ImageRectSize = (iconData and type(iconData) == "table") and iconData.ImageRectSize or Vector2.new(0,0),
                            ThemeTag = {ImageColor3 = "Text"}
                        }
                    ),
                    j(
    ...
    [14] = function()
        ...
        function o.New(p, q, r, s)
            ...
            function x.AddSection(z, A, iconName)
                local B, C = {Type = "Section"}, e(n.Section)(A, x.Container, iconName)
                B.Container = C.Container
        ...
        return function(t)
            ...
            if t.TabLogo then
                ...
                local logoFrame = s("Frame",{
                    Name="TabLogoFrame",
                    Size=UDim2.new(1,-3,0,logoH),
                    Position=UDim2.fromOffset(1,topOffset + 1),
                ...
                do
                    ...
                    if eyeImg then
                        ...
                        m.AddSignal(eyeBtn.MouseButton1Click, function()
                            ...
                            if dnLbl then dnLbl.Text = anonActive and "Unknown" or realDisplayName end
                            if unLbl then unLbl.Text = anonActive and "@Unknown" or realUsername end
    ...
    [59] = function()
        ...
        l.__type = "Discord"
        function l.New(m, n)
            n = (type(n) == "table") and n or {}
            local o = e(k.Element)("", "", m.Container, true)
            o.Frame.Size = UDim2.new(1, 0, 0, 78)
            o.Frame.BackgroundTransparency = 0.82
            
            local inviteCode = tostring(n.InviteCode or n.Invite or ""):match("[%w%-]+$") or ""
            
            local iconBg = j("Frame",{
            ...
            j("UICorner",{CornerRadius = UDim.new(0.2, 0), Parent = iconBg})
            
            local iconImg = j("ImageLabel",{Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Parent = iconBg})
            j("UICorner",{CornerRadius = UDim.new(0.2, 0), Parent = iconImg})
            
            local defaultIco = m.Library.GetIcon and m.Library:GetIcon("solar/chat-round-bold")
            ...
            j("UICorner",{CornerRadius = UDim.new(0, 8), Parent = joinBtn})
            ...
            j("UICorner",{CornerRadius = UDim.new(1, 0), Parent = dot})
            
            local onlineLabel = j("TextLabel",{
                FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json"),
                Text = "",
                TextSize = 10,
                TextXAlignment = Enum.TextXAlignment.Left,
            ...
            i.AddSignal(joinBtn.MouseButton1Click, function()
                if inviteCode ~= "" then
                    local full = "https://discord.gg/" .. inviteCode
                    pcall(function() setclipboard(full) end)
                    m.Library:Notify({Title = "Discord", Content = "Copied: " .. full, Type = "Info", Duration = 3})
                end
            end)
            
            fetchData(inviteCode)
            
            function o:SetInvite(code)
    ...
    [60] = function()
        ...
        function l.New(m, n)
            ...
            local height = n.Height or 200
            local focused = n.Focused ~= false
            local interactive = n.Interactive or false
            local camera = n.Camera or Instance.new("Camera")
            local obj = n.Object
            local aspectRatio = n.AspectRatio
            ...
            local cornerR = (m.Library.Window and m.Library.Window.ElementConfig and m.Library.Window.ElementConfig.UICorner) or 8
            ...
            local function _recalcAspectVp()
                ...
                if w > 0 then
                    local calculatedHeight = math.floor(w / _ratioNum)
                    vpFrame.Size = UDim2.new(1, 0, 0, calculatedHeight)
                    o.Frame.Size = UDim2.new(1, 0, 0, calculatedHeight)
                end
            end
            vpFrame:GetPropertyChangedSignal("AbsoluteSize"):Connect(_recalcAspectVp)
            if _ratioNum then task.defer(_recalcAspectVp) end
            
            local corner = j("UICorner", {CornerRadius = UDim.new(0, cornerR), Parent = vpFrame})
            
            local bg = j("ImageLabel", {
                Size = UDim2.fromScale(1, 1),
            ...
            j("UICorner", {CornerRadius = UDim.new(0, cornerR), Parent = bg})
            i.AddThemeObject(bg, {BackgroundColor3 = "ViewportBackground"})
            
            local bgNoise = j("ImageLabel", {
                Name = "_ViewportNoise",
                Image = "rbxassetid://9968344227",
                ScaleType = Enum.ScaleType.Tile,
                TileSize = UDim2.new(0, 128, 0, 128),
                ...
                Visible = i.GetThemeProperty("ViewportBackgroundImages") ~= false,
                Parent = bg,
            })
            j("UICorner", {CornerRadius = UDim.new(0, cornerR), Parent = bgNoise})
            i.AddThemeObject(bgNoise, {Visible = "ViewportBackgroundImages"})
            
            local canvas = j("CanvasGroup", {Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Parent = vpFrame})
            j("UICorner", {CornerRadius = UDim.new(0, cornerR), Parent = canvas})
            
            local vpInner = j("ViewportFrame", {
                Name = "Viewport",
                Size = UDim2.fromScale(1, 1),
                BackgroundTransparency = 1,
                CurrentCamera = o.Camera,
                Active = o.Interactive,
                Parent = canvas,
            })
            o.Object.Parent = vpInner
            
            local stroke = j("UIStroke", {Transparency = 0.6, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Parent = vpFrame})
            i.AddThemeObject(stroke, {Color = "InElementBorder"})
            ...
            i.AddSignal(vpInner.MouseEnter, function()
                if o.Interactive then
                    local sf = m.ScrollFrame
                    if sf then sf.ScrollingEnabled = false end
                end
            end)
            i.AddSignal(vpInner.InputEnded, function(inp)
                if inp.UserInputType == Enum.UserInputType.MouseMovement or inp.UserInputType == Enum.UserInputType.Touch then
                    local sf = m.ScrollFrame
                    if sf then sf.ScrollingEnabled = true end
                end
            end)
            i.AddSignal(vpInner.InputBegan, function(inp)
                if o.Interactive then
                    if inp.UserInputType == Enum.UserInputType.MouseButton1 or (inp.UserInputType == Enum.UserInputType.Touch and not _Pinching) then
                        _Dragging = true
                        _LastMousePos = inp.Position
                    end
                end
            end)
            i.AddSignal(_UIS.InputEnded, function(inp)
                if o.Interactive then
            ...
            i.AddSignal(_UIS.InputChanged, function(inp)
                if o.Interactive and _Dragging and not _Pinching then
                    if inp.UserInputType == Enum.UserInputType.MouseMovement or inp.UserInputType == Enum.UserInputType.Touch then
                        local delta = inp.Position - _LastMousePos
                        _LastMousePos = inp.Position
                        local pos = o.Object:GetPivot().Position
                        local cam = o.Camera
            ...
            i.AddSignal(vpInner.InputChanged, function(inp)
                if o.Interactive then
                    if inp.UserInputType == Enum.UserInputType.MouseWheel then
                        if not _posInViewport(_UIS:GetMouseLocation()) then return end
                        local zoom = inp.Position.Z * 2
                        o.Camera.CFrame += o.Camera.CFrame.LookVector * zoom
                    end
                end
            end)
            i.AddSignal(_UIS.TouchPinch, function(touches, scale, vel, state)
                if o.Interactive then
                    ...
                    elseif state == Enum.UserInputState.Change then
                        ...
                        _LastPinchDist = cur
                        o.Camera.CFrame += o.Camera.CFrame.LookVector * d
            ...
            local function focusCamera()
                local sz = o.Object:IsA("BasePart") and o.Object.Size or select(2, o.Object:GetBoundingBox(0))
                local ext = math.max(sz.X, sz.Y, sz.Z)
                local mpos = o.Object:GetPivot().Position
                o.Camera.CFrame = CFrame.new(mpos + Vector3.new(0, ext / 2, ext * 2), mpos)
            end
            if o.Focused then focusCamera() end
            
            function o:SetObject(obj, clone)
                if clone then obj = obj:Clone() end
                if o.Object then o.Object:Destroy() end
                o.Object = obj
                o.Object.Parent = vpInner
            end
            function o:SetHeight(h)
                ...
                o.Frame.Size = UDim2.new(1, 0, 0, h)
            end
            function o:SetAspectRatio(ratio)
                local rNum = _parseAspect(ratio)
                _ratioNum = rNum
                if rNum then 
                    _recalcAspectVp() 
                else 
                    vpFrame.Size = UDim2.new(1, 0, 0, o.Height)
                    o.Frame.Size = UDim2.new(1, 0, 0, o.Height)
                end
            end
            function o:Focus()
                if o.Object then focusCamera() end
            end
            function o:SetCamera(cam)
                o.Camera = cam
                vpInner.CurrentCamera = cam
            end
            function o:SetInteractive(val)
                o.Interactive = val
                vpInner.Active = val
            end
            
            o.Frame.Size = UDim2.new(1, 0, 0, height)
    ...
    [61] = function()
        ...
        function l.New(m, n, o)
            local opts = (type(n) == "table" and n) or (type(o) == "table" and o) or {}
            local o = e(k.Element)("", "", m.Container, true)

            local parent = m.Container
            ...
            local function applyIcon(imgLabel, iconName)
                local ic = m.Library and m.Library:GetIcon(iconName)
                if ic and type(ic)=="table" then
            ...
            local wrap = u("Frame",{
                ...
                Parent=o.Frame, ThemeTag={BackgroundColor3="Element"},
            })
            ...
            local function _recalcAspect2()
                ...
                if w > 0 and ratioNum2 and ratioNum2 > 0 then
                    ...
                    o.Frame.Size = UDim2.new(1, 0, 0, wrap.Size.Y.Offset)
                end
            end
            ...
            if not hasVideo then
                ...
                o.Frame.Size = UDim2.new(1, 0, 0, 180)
                local oldDestroy = o.Destroy
                function o:Destroy() if oldDestroy then oldDestroy(o) else o.Frame:Destroy() end end
                return o
            end
            ...
            local hbConn=rs2.Heartbeat:Connect(function(dt)
                if not o.Frame.Parent then return end
                -- Auto-hide timer
                if ctrlVisible then
            ...
            o.Type = "Video"
            o.VideoFrame = vid            
            function o:Play()  if vid then pcall(function() vid:Play()  end); playing=true;  playBtn.Visible=false; pauseBtn.Visible=true  end end
            function o:Pause() if vid then pcall(function() vid:Pause() end); playing=false; playBtn.Visible=true;  pauseBtn.Visible=false end end
            function o:Stop()  if vid then pcall(function() vid:Stop()  end); playing=false; playBtn.Visible=true;  pauseBtn.Visible=false end end
            function o:SetVideo(s)
                if not vid then return end
    ...
    [62] = function()
        ...
        function l.New(m, n, o)
            ...
            local function resolve(sourceStr)
                if type(sourceStr) ~= "string" or sourceStr == "" then return "" end

                if sourceStr:match("^rbxassetid://") or sourceStr:match("^rbxasset://") then 
                    return sourceStr 
                end

                if sourceStr:match("^%d+$") then 
                    return "rbxassetid://" .. sourceStr 
                end

                if sourceStr:match("^https?://") then
                    local nameFile = "moon_image_cache_" .. string.match(sourceStr, "([^/]+)$") or "temp_img.png"
                    nameFile = nameFile:gsub("[%?%&%=\\%/]", "_")
                    if not nameFile:match("%.%w+$") then nameFile = nameFile .. ".png" end
                    
                    local success, result = pcall(function()
                        if not isfile(nameFile) then
                            local Imagedata = game:HttpGet(sourceStr)
                            writefile(nameFile, Imagedata)
                        end
                        return getcustomasset(nameFile)
                    end)
                    
                    if success then return result end
                end

                local mm = m.Library and m.Library.MediaManager
                if mm then return mm:Image(sourceStr) end
            ...
            setmetatable(o, l)
            o.Type = "Image"            
            function o:SetImage(newSrc) 
                img.Image = resolve(newSrc) 
            end            
            function o:SetAspectRatio(r)
            ...
            function o:Destroy() 
                if wrap then wrap:Destroy() end
                if oldDestroy then oldDestroy(o) else o.Frame:Destroy() end
            end            
            return o
        end
        return l
    ...
    [63] = function()
        ...
        local platformIcons = {
            Youtube = "rbxassetid://11866580082",     
            Video = "rbxassetid://14333878774",       
            Views = "rbxassetid://10723346959",       
            Repo = "rbxassetid://100250308416084",    
            Followers = "rbxassetid://15781236851",   
            Heart = "rbxassetid://139839073669225"    
        }
        ...
        function l.New(C, cfg)
            cfg = (type(cfg) == "table") and cfg or {}

            local o = e(k.Element)("", "", C.Container, true)
            o.Frame.Size = UDim2.new(1, 0, 0, 80)
            o.Frame.BackgroundTransparency = 0.82
            o.Frame.BorderSizePixel = 0
            o.Frame.ClipsDescendants = false 

            local u = j
            local profileUrl = cfg.ProfileUrl or cfg.Url or ""
            local username = ""
            local platformText = "Social"
            local platformLower = ""

            if type(profileUrl) == "string" and profileUrl ~= "" then
                local host, path = profileUrl:match("^https?://([^/]+)/?(.-)[/?#]?$")
                if not host then host, path = profileUrl:match("^([^/]+)/?(.-)[/?#]?$") end
                ...
                if host then
                    ...
                    if _hostMap[host] then
                        platformText = _hostMap[host]
                        platformLower = platformText:lower()
                    end
                    local user = path and path:match("^([^/?#]+)")
                    if user and user ~= "" then
                        if user:lower() == "channel" then
                            local channelId = path:match("^channel/([^/?#]+)")
                            if channelId then user = channelId end
                        end
            ...
            local finalName = username
            if platformLower == "youtube" and username ~= "" then
                finalName = "@" .. username
            end
            local displayName = tostring(cfg.DisplayName or (finalName ~= "" and finalName or "User"))

            u("UICorner",{CornerRadius=UDim.new(0,12),Parent=o.Frame})
            u("UIStroke",{Transparency=0.45,Thickness=1,ThemeTag={Color="InElementBorder"},Parent=o.Frame})
            ...
            if username ~= "" or profileUrl ~= "" then
            ...
            local function rebuildStats(pieces)
                ...
                for idx, item in ipairs(pieces) do
                    ...
                    elseif item.type == "text" then
                        u("TextLabel", {
                            ...
                            TextSize = 11,
                            TextColor3 = Color3.fromRGB(255, 255, 255),
                            Size = UDim2.new(0, math.max(10, #item.text * 7), 1, 0),
                            BackgroundTransparency = 1,
                            ThemeTag = {TextColor3 = "SubText"},
                            LayoutOrder = idx,
                            Parent = statsHolder
            ...
            if platformLower == "tiktok" then
                rebuildStats({
                    {type = "icon", asset = platformIcons.Followers}, {type = "text", text = "0 "},
                    {type = "icon", asset = platformIcons.Heart}, {type = "text", text = "0"}
                })
            elseif platformLower == "github" then
                rebuildStats({
                    {type = "icon", asset = platformIcons.Followers}, {type = "text", text = "0 "},
                    {type = "icon", asset = platformIcons.Repo}, {type = "text", text = "0"}
                })
            elseif platformLower == "youtube" then
                rebuildStats({
                    {type = "icon", asset = platformIcons.Youtube}, {type = "text", text = "Subs: 0 "},
                    {type = "icon", asset = platformIcons.Views}, {type = "text", text = "Views: 0 "},
                    {type = "icon", asset = platformIcons.Video}, {type = "text", text = "Vids: 0"}
                })
            else
                rebuildStats({{type = "text", text = username ~= "" and ("@"..username) or "Loading..."}})
            end

            local platformLabel = u("TextLabel",{
                Name="PlatformLabel",
                Text=platformText,
                FontFace=Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Medium),
                TextSize=10,
            ...
            if profileUrl ~= "" then
                copyBtn = u("TextButton",{
                    ...
                    Position=UDim2.new(1,-12,0.68,0),
                    AnchorPoint=Vector2.new(1,0.5),
                    TextColor3=Color3.fromRGB(255,255,255),
                    FontFace=Font.new("rbxasset://fonts/families/GothamSSm.json",Enum.FontWeight.SemiBold),
                    TextSize=11,
            ...
            local refreshBtn
            local targetQuery = (platformLower == "youtube") and (cfg.Counts or username) or username
            local hasAPI = (platformLower == "tiktok" or platformLower == "github" or (platformLower == "youtube" and targetQuery ~= ""))

            if hasAPI and targetQuery ~= "" then
                refreshBtn = u("ImageButton",{
                    Name="RefreshButton",
                    Image="rbxassetid://10734933222",
                    Size=UDim2.fromOffset(16,16),
                    Position = UDim2.new(1, -23, 0, 12),
                    AnchorPoint = Vector2.new(1, 0),
                    BackgroundTransparency=1,
                    ThemeTag={ImageColor3="Text"},
                    Parent=o.Frame,
            ...
            local rotateAnim = nil

            local function fetchSocialStats()
                if isFetching or targetQuery == "" or not hasAPI then return end
                isFetching = true

                if refreshBtn then
                    refreshBtn.Rotation = 0
                    rotateAnim = TweenService:Create(refreshBtn, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {Rotation = 360})
                    rotateAnim:Play()
                end
                ...
                task.spawn(function()
                    ...
                    if req then
                        local apiURL = ""
                        if platformLower == "tiktok" then
                            apiURL = "https://tikwm.com/api/user/info?unique_id=" .. targetQuery
                        elseif platformLower == "github" then
                            apiURL = "https://api.github.com/users/" .. targetQuery
                        elseif platformLower == "youtube" then
                            apiURL = "https://api.socialcounts.org/youtube-live-subscriber-count/" .. targetQuery
                        end

                        if apiURL ~= "" then
                            local ok, response = pcall(function() return req({ Url = apiURL, Method = "GET", Timeout = 8 }) end)
                            if ok and response.StatusCode == 200 then
                                local HttpService = game:GetService("HttpService")
                                local dataOk, resTable = pcall(function() return HttpService:JSONDecode(response.Body) end)

                                if dataOk and resTable then
                                    if platformLower == "tiktok" and resTable.data and resTable.data.stats then
                                        local s = resTable.data.stats
                                        rebuildStats({
                                            {type = "icon", asset = platformIcons.Followers}, {type = "text", text = formatNumber(s.followerCount) .. " "},
                                            {type = "icon", asset = platformIcons.Heart}, {type = "text", text = formatNumber(s.heartCount)}
                                        })
                                        successFetch = true
                                    elseif platformLower == "github" and resTable.followers then
                                        rebuildStats({
                                            {type = "icon", asset = platformIcons.Followers}, {type = "text", text = formatNumber(resTable.followers) .. " "},
                                            {type = "icon", asset = platformIcons.Repo}, {type = "text", text = formatNumber(resTable.public_repos)}
                                        })
                                        successFetch = true
                                    elseif platformLower == "youtube" and resTable.counters and resTable.counters.estimation then
                                        local est = resTable.counters.estimation
                                        rebuildStats({
                                            {type = "icon", asset = platformIcons.Youtube}, {type = "text", text = formatNumber(est.subscriberCount) .. " "},
                                            {type = "icon", asset = platformIcons.Views}, {type = "text", text = formatNumber(est.viewCount) .. " "},
                                            {type = "icon", asset = platformIcons.Video}, {type = "text", text = formatNumber(est.videoCount)}
                                        })
                                        successFetch = true
                                    end
                                end
                    ...
                    if not successFetch then
                        if platformLower == "youtube" then
                            rebuildStats({{type = "icon", asset = platformIcons.Youtube}, {type = "text", text = "Can't find stats"}})
                        else
                            rebuildStats({{type = "text", text = "❌ Can't find @" .. targetQuery}})
                        end
                    end
                    ...
                    if refreshBtn then
                        TweenService:Create(refreshBtn, TweenInfo.new(0.2), {Rotation = 0}):Play()
                    end
                    isFetching = false
                end)
            end
            local function _copy(text, label)
                ...
                C.Library:Notify({Title="Copied", Content=(label or "Text").." copied to clipboard", Type="Success", Duration=2})
            end
            i.AddSignal(nameBtn.MouseButton1Click, function() _copy(displayName, "Display name") end)
            
            local statsClick = u("TextButton", {Size = UDim2.fromScale(1,1), BackgroundTransparency = 1, Text = "", Parent = statsHolder})
            i.AddSignal(statsClick.MouseButton1Click, function() _copy(username, "Username") end)

            if copyBtn then
                i.AddSignal(copyBtn.MouseButton1Click, function() _copy(profileUrl, "Profile link") end)
            end
            if refreshBtn then
                i.AddSignal(refreshBtn.MouseButton1Click, fetchSocialStats)
            end

            task.spawn(function()
                if hasAPI then fetchSocialStats() end
                local avatarSrc = cfg.Avatar
                local imgUrl
                if type(avatarSrc) == "string" and avatarSrc:match("^https?://") then
                    imgUrl = avatarSrc
                elseif username ~= "" and platformLower ~= "" then
                    imgUrl = "https://unavatar.io/" .. platformLower .. "/" .. username
                end

                if imgUrl then
                    task.spawn(function()
                        if not avatarImg.Image:match("rbxassetid") or avatarImg.Image == "" then
                            local ok, asset = pcall(function() return C.Library.MediaManager and C.Library.MediaManager:Image(imgUrl) end)
    ...
    [64] = function()
        ...
        l.__type = "Group"
        local TweenService = game:GetService("TweenService")
        function l.New(d, title, options)
            local D = (type(title) == "table" and title) or (type(options) == "table" and options) or {}
            local titleText = (type(title) == "string" and title) or D.Title or ""
            local descText = D.Description or ""
            ...
            local o = e(k.Element)(titleText, descText, parent, true)
            o.Frame.AutomaticSize = Enum.AutomaticSize.Y
            o.Frame.Size = UDim2.new(1, 0, 0, 0)

            local labelHolder = o.Frame:FindFirstChild("LabelHolder")
            if labelHolder then
                labelHolder.Position = UDim2.fromOffset(12, 10)
                labelHolder.Size = UDim2.new(1, -170, 0, 35)
            end

            local searchBoxContainer = u("Frame", {
                ...
                u("UICorner", {CornerRadius = UDim.new(0, 5)}),
                u("UIStroke", {
                    Thickness = 1,
                    ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                    ThemeTag = {Color = "InElementBorder"}
            ...
            o._section = d
            o._currentCol = 0
            function o:SetSection(sec) 
                self._section = sec 
            end
            function o:AddElement()
                local el = u("Frame", {
                    Size = UDim2.new(colScale, colOffset, 0, 0),
                    BackgroundTransparency = 1,
                    AutomaticSize = Enum.AutomaticSize.Y,
                    Parent = wrap,
                    LayoutOrder = o._currentCol
                })
                o._currentCol = o._currentCol + 1
                ...
                local colObj = setmetatable({
                    Container = el,
                    Type = sec and sec.Type or d.Type or nil,
                    ScrollFrame = sec and sec.ScrollFrame or d.ScrollFrame or nil,
                    _elementCount = 0,
                    Library = d.Library
                }, {
                    __index = d.Library and d.Library.Elements or nil
                })

                function colObj:AddImageButton(config)
                    config = config or {}
                    local imgTitle = config.Title or "Image Title"
                    local imgDesc = config.Description or ""
                    local imgAsset = config.Image or ""
                    local callback = config.Callback or function() end
                    local ratio = config.AspectRatio or "16:9"
                    local radius = config.Radius or 8

                        local function resolve(sourceStr)
                            if type(sourceStr) ~= "string" or sourceStr == "" then return "" end
                            if sourceStr:match("^rbxassetid://") or sourceStr:match("^rbxasset://") or sourceStr:match("^rbxthumb://") then 
                                return sourceStr 
                            end
                            if sourceStr:match("^%d+$") then 
                            return "rbxassetid://" .. sourceStr 
                        ...
                        if sourceStr:match("^https?://") then
                            local endPath = string.match(sourceStr, "([^/]+)$") or "temp_img.png"
                            local nameFile = "moon_image_cache_" .. endPath
                            nameFile = nameFile:gsub("[%?%&%=\\%/]", "_")
                            if not nameFile:match("%.%w+$") then nameFile = nameFile .. ".png" end
                            local success, result = pcall(function()
                                if not isfile(nameFile) then
                    ...
                    local cardCorner = u("UICorner", {CornerRadius = UDim.new(0, radius), Parent = imageCard})

                    local clickDetector = u("ImageButton", {
                        Size = UDim2.fromScale(1, 1),
                        BackgroundTransparency = 1,
                        ImageTransparency = 1,
                        Active = true,
                    ...
                    local containerCorner = u("UICorner", {CornerRadius = UDim.new(0, radius), Parent = imgContainer})
                    ...
                    local img = u("ImageLabel", {
                        ...
                        Position = UDim2.fromScale(0.5, 0.5),
                        BackgroundTransparency = 1,
                        Image = resolve(imgAsset),
                        ScaleType = Enum.ScaleType.Crop,
                        ZIndex = 1,
                        Parent = imgContainer,
                    })
                    local imgCorner = u("UICorner", {CornerRadius = UDim.new(0, radius), Parent = img})

                    local strokeOverlay = u("Frame", {
                        Size = UDim2.fromScale(1, 1),
                        BackgroundTransparency = 1,
                        BorderSizePixel = 0,
                        ZIndex = 4,
                    ...
                    local strokeCorner = u("UICorner", {CornerRadius = UDim.new(0, radius), Parent = strokeOverlay})
                    local stroke = u("UIStroke", {
                        Transparency = 0.4, 
                        Thickness = 1, 
                        ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                        Parent = strokeOverlay,
                        ThemeTag = {Color = "AcrylicBorder"}
                    })

                    local bottomShadow = u("Frame", {
                    ...
                    local shadowCorner = u("UICorner", {CornerRadius = UDim.new(0, radius), Parent = bottomShadow})
                    u("UIGradient", {
                        Rotation = 90,
                    ...
                    u("UIListLayout", {SortOrder = Enum.SortOrder.LayoutOrder, Padding = UDim.new(0, 2), Parent = textHolder})
                    ...
                    local function _recalcAspect()
                        local w = imageCard.AbsoluteSize.X
                        if w > 0 and ratioNum and ratioNum > 0 then
                            imageCard.Size = UDim2.new(1, 0, 0, math.floor(w / ratioNum))
                        end
                    end
                    imageCard:GetPropertyChangedSignal("AbsoluteSize"):Connect(_recalcAspect)
                    task.defer(_recalcAspect)

                    local tweenInfoQuick = TweenInfo.new(0.06, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
                    local tweenInfoSmooth = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)

                    local lastInteracted = 0

                    local function applyNormalState()
                        local baseColor = d.Library.Themes.Element or Color3.fromRGB(32, 32, 32)
                        TweenService:Create(imageCard, tweenInfoSmooth, {BackgroundColor3 = baseColor}):Play()
                        TweenService:Create(img, tweenInfoSmooth, {Size = UDim2.fromScale(1.0, 1.0)}):Play()

                        TweenService:Create(cardCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, radius)}):Play()
                        TweenService:Create(containerCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, radius)}):Play()
                        TweenService:Create(imgCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, radius)}):Play()
                        TweenService:Create(strokeCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, radius)}):Play()
                        TweenService:Create(shadowCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, radius)}):Play()
                    end

                    local function applyActiveBoxState()
                        local targetColor = d.Library.Themes.Hover or Color3.fromRGB(45, 45, 45)
                        TweenService:Create(imageCard, tweenInfoSmooth, {BackgroundColor3 = targetColor}):Play()
                        TweenService:Create(img, tweenInfoSmooth, {Size = UDim2.fromScale(1.06, 1.06)}):Play()

                        TweenService:Create(cardCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, 0)}):Play()
                        TweenService:Create(containerCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, 0)}):Play()
                        TweenService:Create(imgCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, 0)}):Play()
                        TweenService:Create(strokeCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, 0)}):Play()
                        TweenService:Create(shadowCorner, tweenInfoSmooth, {CornerRadius = UDim.new(0, 0)}):Play()
                    end

                    local function triggerAction()
                        lastInteracted = os.clock()

                        local clickIn = TweenService:Create(img, tweenInfoQuick, {Size = UDim2.fromScale(0.96, 0.96)})
                        clickIn:Play()
                        ...
                        task.spawn(function()
                            ...
                            local currentSession = lastInteracted
                            task.wait(0.5)
                            if lastInteracted == currentSession then
                                applyNormalState()
                            end
                        end)
                        ...
                        if d.Library.SafeCallback then
                            d.Library:SafeCallback(callback)
                        else
                            pcall(callback)
                        end
                    end

                    i.AddSignal(clickDetector.MouseButton1Click, triggerAction)
                    i.AddSignal(clickDetector.MouseEnter, function()
                        lastInteracted = os.clock()
                        applyActiveBoxState()
                    end)
                    i.AddSignal(clickDetector.MouseLeave, function()
                        local currentSession = os.clock()
                        lastInteracted = currentSession
                        task.wait(0.5)
                        if lastInteracted == currentSession then
                            applyNormalState()
                        end
                    ...
                    local colMethods = {}
                    function colMethods:SetImage(newSrc)
                        img.Image = resolve(newSrc)
                    end
                    function colMethods:SetAspectRatio(r)
                        ratioNum = parseRatio(r)
                        _recalcAspect()
                    end
                    function colMethods:Destroy()
                        if imageCard then imageCard:Destroy() end
                    end
                    return colMethods
                end

                table.insert(o.Elements, {Frame = el, ColObj = colObj})
                return colObj
            end

            searchBox:GetPropertyChangedSignal("Text"):Connect(function()
                local searchText = searchBox.Text:lower():gsub("^%s+", ""):gsub("%s+$", "")
                for _, elementData in ipairs(o.Elements) do
                    local columnFrame = elementData.Frame
                    if columnFrame then
                        local visibleElementsInCol = 0
                        for _, child in ipairs(columnFrame:GetChildren()) do
                            if child:IsA("Frame") or child:IsA("ImageButton") then
                                if searchText == "" then
                                    child.Visible = true
                                    visibleElementsInCol = visibleElementsInCol + 1
                                else
                                    local standsMatch = false

                                    local descendants = child:GetDescendants()
                                    table.insert(descendants, child) 
                                    for _, desc in ipairs(descendants) do
                                        if desc:IsA("TextLabel") or desc:IsA("TextBox") or desc:IsA("TextButton") then
                                            local textContent = desc.Text:lower()
                                            local placeholderContent = desc:IsA("TextBox") and desc.PlaceholderText:lower() or ""
                                            if textContent:find(searchText, 1, true) or placeholderContent:find(searchText, 1, true) then
                                                standsMatch = true
                                                break
                                            end
                                        end
                        ...
                        if visibleElementsInCol > 0 or searchText == "" then
    ...
    [47] = function()
        ...
        local af = {
            Names = {
                "Darker", "Ash Gray", "Red", "Cyanic", "Arctic Frost", "Amber Glow", "Deep Violet", "Neon Cyber", "Neon Purple", "Royal Blue", "Deep Ocean", "RGB", "Orange", "Charcoal", "Pearl White", "Summer", "Midnight Blue", "Galaxy Purple", "Cosmic Violet", "Cotton Candy"
            }
        }
    ...
    [65] = function()
        ...
        local bgFileName = "Ju-Fufu-zzz_BG.jpg"
        local bgUrl = "https://od.lk/d/ODhfMjA1MDMyMzhf/IMG_20260711_072333.jpg"

        local req = (syn and syn.request) or http_request or request
        local getAsset = getcustomasset or getgenv().getcustomasset or drawing_asset or getasset
        
        if writefile and readfile and req and getAsset then
            local fileExists = pcall(function() return readfile(bgFileName) end)
            
            if not fileExists then
                local ok, response = pcall(function() 
                    return req({ Url = bgUrl, Method = "GET" }) 
                end)
                if ok and response.StatusCode == 200 and response.Body then
                    writefile(bgFileName, response.Body)
                    task.wait(0.1) 
                end
            end

            pcall(function()
                local asset = getAsset(bgFileName)
                if asset and asset ~= "" then
                    finalImageAsset = asset
                end
            end)
        end
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(60, 60, 60),
            AcrylicBorder = Color3.fromRGB(90, 90, 90),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 40, 40), Color3.fromRGB(30, 30, 30)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(75, 75, 75),
            Tab = Color3.fromRGB(0, 100, 150),
            Element = Color3.fromRGB(0, 80, 120),
            ElementBorder = Color3.fromRGB(35, 35, 35),
            InElementBorder = Color3.fromRGB(200, 130, 30),
            ...
            ToggleToggled = Color3.fromRGB(255, 255, 255),
            SliderRail = Color3.fromRGB(0, 100, 150),
            DropdownFrame = Color3.fromRGB(0, 90, 135),
            DropdownHolder = Color3.fromRGB(45, 45, 45),
            DropdownBorder = Color3.fromRGB(0, 70, 105),
            DropdownOption = Color3.fromRGB(255, 170, 40),
            Keybind = Color3.fromRGB(0, 80, 120),
            Input = Color3.fromRGB(0, 70, 105),
            InputFocused = Color3.fromRGB(10, 10, 10),
            InputIndicator = Color3.fromRGB(255, 195, 80),
            Dialog = Color3.fromRGB(45, 45, 45),
            DialogHolder = Color3.fromRGB(35, 35, 35),
            DialogHolderLine = Color3.fromRGB(185, 120, 25),
            DialogButton = Color3.fromRGB(0, 80, 120),
            DialogButtonBorder = Color3.fromRGB(200, 130, 30),
            DialogBorder = Color3.fromRGB(140, 88, 18),
            DialogInput = Color3.fromRGB(55, 55, 55),
            DialogInputLine = Color3.fromRGB(255, 195, 80),
            Text = Color3.fromRGB(255, 245, 225),
            ...
            Background = finalImageAsset,
            BackgroundTransparency = 0,
            ThemeAccentColors = {Color3.fromRGB(255, 170, 40), Color3.fromRGB(0, 150, 200)},
            ViewportBackground = Color3.fromRGB(15, 15, 20),
            ViewportBackgroundImages = true,
            DropdownOutsideWindowBackground = Color3.fromRGB(35, 35, 35),
            DropdownOutsideWindowBackgroundImages = true
