...
function FluentModify:CountdownNotify(config)
    ...
    local baseSubContent = config.SubContent or ""
...
function FluentModify:CustomNotify(config)
    ...
    elseif rawColor and typeof(rawColor) == "Color3" then
        ...
        finalGradientColor = ColorSequence.new(Color3.fromRGB(20, 20, 20))
    end
    ...
    titleLabel.Position = UDim2.new(0, 14, 0, 17)
    titleLabel.Size = UDim2.new(1, -12, 0, 12)
    ...
    labelHolder.Position = UDim2.fromOffset(14, 40)
    ...
    closeIcon.ImageColor3 = mainTextColor -- Tombol close x ikut berubah warna cerah/gelap
